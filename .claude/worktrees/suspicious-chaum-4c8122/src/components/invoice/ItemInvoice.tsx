...
const ItemInvoice: React.FC<ItemInvoiceProps> = ({ transaction, onPrint }) => {
    ...
    return (
        <div id="item-invoice" className="bg-white mx-auto font-mono" style={{ width: '58mm', padding: '2mm 2mm', fontSize: '11px', lineHeight: '1.3' }}>
            {/* Header */}
            ...
            {(transaction.userName || transaction.setName) && (
                <>
                    ...
                    {transaction.setName && (
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px' }}>
                            <span style={{ fontWeight: 700 }}>Set:</span>
                            <span>{transaction.setName}</span>
                        </div>
                    )}
                    <hr style={{ border: 'none', borderTop: '1px dashed #000', margin: '4px 0' }} />
                </>
            ...
            <div style={{ marginBottom: '2px' }}>
                ...
                {transaction.items && transaction.items.length > 0 ? (
                    ...
                    <div style={{ textAlign: 'center', fontSize: '10px' }}>No items</div>
                )}
            </div>
            <hr style={{ border: 'none', borderTop: '1px dashed #000', margin: '4px 0' }} />
