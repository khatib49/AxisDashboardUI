...
import { getOpenBoardGameSessions, closeGameSession, OpenSessionDto } from '../../services/transactionService';
...
const BoardGameSessions: React.FC = () => {
    ...
    const loadSessions = async () => {
        ...
        setError(null);
        try {
            const response = await getOpenBoardGameSessions();
            if (response.success) {
        ...
        <div className="p-6">
            ...
            {!loading && !error && sessions.length === 0 && (
                <div className="text-center py-20 text-gray-500">
                    ...
                    <p className="text-sm mt-1">All board game sessions are currently closed</p>
                </div>
            )}
                    ...
                    {sessions.map((session) => (
                        ...
                        >
                            ...
                            <div className="p-4 space-y-3">
                                ...
                                {/* Client row — click to attach or change. Shows
                                    "+ Add Client" placeholder when unset. */}
                                <div className="flex items-center justify-between text-sm">
            ...
            {attachingSession && (
                <AttachClientModal
                    ...
                    onSaved={(userId, userName) => {
                        // Optimistically update the card so the cashier sees the
                        // change instantly, then close the modal.
...
export default BoardGameSessions;
